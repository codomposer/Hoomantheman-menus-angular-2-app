...
const key = 'ro_menuitem_is_new_unselected_size$'
export const ro_menuitem_is_new_unselected_size$_b:B<ro_menu_ui_Ctx, typeof key> = be_(key, ctx=>{
	...
	return derived$(tup(
			params_MenuItemID_isNew$, ro_Menuitem_is_new_singlesize$, ro_menuitem_is_new_multisize$
		),
		([
	...
	) as ro_menuitem_is_new_unselected_size$_T
})
export type ro_menuitem_is_new_unselected_size$_T = Readable$<boolean>
