...
import type {
	CustomerReview, DeliveryZoneItem, FinancialStatement_Detail, FinancialStatement_Summary, GraphDatum, Holiday,
	MapInfo, MenuCounts, OptionGroupSuggestion, OrderDetail_I, RoOrder, PaymentMethod_I,
	RestaurantAccountInformation, RestHours, RoCoupon, RoHeading_I, RoMasterheading_I, RoMenuitem, RoMenuitem_I,
	RoMenuoption_I, RoMenuoptionitem_I, RoMenuoptionsize_I, RoPreviewMasterheading_I, Schedule
...
export type fetch_API_MENUS_sched_list_payload_T = Schedule
export type API_MENUS_sched_add_payload_T = Schedule
export interface success_API_MENUS_masterheading_list_payload_T {
	Status:string
	Data:RoMasterheading_I[]
}
export type error_API_MENUS_masterheading_list_payload_T = API_error_T
export type API_MENUS_masterheading_list_payload_T =
	success_API_MENUS_masterheading_list_payload_T
	|error_API_MENUS_masterheading_list_payload_T
...
export type save_API_MENUS_masterheading_payload_T =
	API_MENUS_masterheading_add_payload_T|API_MENUS_masterheading_update_payload_T
...
export type error_API_MENUS_masterheading_info_payload_T = API_error_T
export type API_MENUS_masterheading_info_payload_T =
...
export type API_MENUS_heading_list_payload_T =
	success_API_MENUS_heading_list_payload_T
	&API_error_T
export interface success_API_MENUS_heading_info_payload_T {
	Data:RoHeading_I
}
export type API_MENUS_heading_info_payload_T =
	success_API_MENUS_heading_info_payload_T
	&API_error_T
...
export type save_API_MENUS_heading_payload_T =
	API_MENUS_heading_add_payload_T
	|API_MENUS_heading_update_payload_T
...
export type error_API_MENUS_menu_list_payload_T = API_error_T
export type API_MENUS_menu_list_payload_T =
...
export type error_API_MENUS_menu_info_payload_T = API_error_T
export type API_MENUS_menu_info_payload_T =
...
export type API_MENUS_sizelookup_payload_T =
	success_API_MENUS_sizelookup_payload_T
	&API_error_T
export interface successAPI_MENUS_menusize_list_payload__T {
	Data:RoMenuoptionsize_I[]
}
export type errorAPI_MENUS_menusize_list_payload__T = API_error_T
export type API_MENUS_menusize_list_payload_T =
...
export type API_MENUS_menusize_save_payload_T =
	API_MENUS_menusize_add_payload_T|API_MENUS_menusize_update_payload_T
...
export type error_API_MENUS_menuoption_list_payload_T = API_error_T
export type API_MENUS_menuoption_list_payload_T =
	success_API_MENUS_menuoption_list_payload_T
	|error_API_MENUS_menuoption_list_payload_T
...
export type save_API_MENUS_menuoption_payload_T =
	API_MENUS_menuoption_add_payload_T|API_MENUS_menuoption_update_payload_T
...
export type API_MENUS_menuoptionitem_list_payload_T = RoMenuoptionitem_I[]
...
export type save_API_MENUS_menuoptionitem_payload_T =
...
export type error_API_MENUS_optiongroup_list_payload_T = API_error_T
export type API_MENUS_optiongroup_list_payload_T =
	success_API_MENUS_optiongroup_list_payload_T
	|error_API_MENUS_optiongroup_list_payload_T
export type success_API_ORDERS_detail_payload_T = RoOrder
export type error_API_ORDERS_detail_payload_T = API_error_T
export type API_ORDERS_detail_payload_T =
...
export type error_API_COUPONS_list_payload_T = API_error_T
export type API_COUPONS_list_payload_T =
	success_API_COUPONS_list_payload_T
	|error_API_COUPONS_list_payload_T
...
export type save_API_COUPONS_payload_T =
	API_COUPONS_add_payload_T
	|API_COUPONS_update_payload_T
...
export type API_CHARTS_map_payload_T = MapInfo
export interface API_CHARTS_compare_Data_T {
	All:{
		ID:number
		Dish:string
		AvgPrice:number
...
export interface API_CHARTS_compare_payload_T {
	Status:string
	Data:API_CHARTS_compare_Data_T[]
	Pagination:PaginationPayload
}
export type API_CHARTS_menucount_payload_T = MenuCounts
export interface API_CHARTS_resttype_payload_item_T {
	Status:string
	Count:number
	RestaurantType:string
}
export type success_API_CHARTS_resttype_payload_T = API_CHARTS_resttype_payload_item_T[]
export interface error_API_CHARTS_resttype_payload_T {
	Status:string
	Message:string
}
export type API_CHARTS_resttype_payload_T =
	success_API_CHARTS_resttype_payload_T
	|error_API_CHARTS_resttype_payload_T
...
export type success_API_CHARTS_segment_payload_T = API_CHARTS_segment_payload_item_T[]
export interface error_API_CHARTS_segment_payload_T {
	Status:string
	Message:string
}
export type API_CHARTS_segment_payload_T =
	success_API_CHARTS_segment_payload_T
	|error_API_CHARTS_segment_payload_T
export interface API_CHARTS_cuisine_payload_T {
	Status:string
}
export interface API_CHARTS_menucompetition_Data_T {
	ALL_Inc_Total:number
	ALL_Pen_Total:number
	DishName:string
	InYourDish:number
	Others:number
	...
	TotalRow:number
	Yours:number
	Yours_Percent:number
	id:number
}
export interface API_CHARTS_menucompetition_payload_T {
	Status:string
	Data:API_CHARTS_menucompetition_Data_T[]
	Pagination:PaginationPayload
}
export interface API_CHARTS_missingmenu_Data_T {
	DishName:string
	Others_INC:number
	Others_INC_Percent:number
	Others_PEN:number
	Others_PEN_Percent:number
	TotalPages:number
	TotalRow:number
	id:number
}
export interface API_CHARTS_missingmenu_payload_T {
	Status:string
	Data?:API_CHARTS_missingmenu_Data_T[]
	Pagination:PaginationPayload
}
...
export type API_GLOBAL_get_payload_T = GlobalSettings
export type API_GLOBAL_lookupstate_payload_T = StateCtx[]
...
export type save_API_PAYMENT_METHODS_payload_T =
	API_PAYMENT_METHODS_add_payload_T
	|API_PAYMENT_METHODS_update_payload_T
...
export type error_API_RESTAURANT_info_payload_T = API_error_T
export type API_RESTAURANT_info_payload$_T =
...
export type save_API_USER_payload_T =
	API_USER_addbyowner_payload_T
	|API_USER_update_payload_T
...
export type API_PLATFORM_companies_payload_T = PlatformCompany[]
...
export type API_RESTAURANT_update_body_T = RoRestaurant_I
export type API_RESTAURANT_schedule_payload_T = API_RESTAURANT_info_payload$_T
...
export type save_API_RESTAURANT_dzone_payload_T =
	API_RESTAURANT_dzone_add_payload_T|API_RESTAURANT_dzone_update_payload_T
export interface API_LIST_cuisine_payload_item_T {
	ID:number
	Name:string
}
export type API_LIST_cuisine_payload_T = API_LIST_cuisine_payload_item_T[]
export interface API_LIST_segment_payload_item_T {
	ID:number
	Name:string
}
export type API_LIST_segment_payload_T = API_LIST_segment_payload_item_T[]
export type Status_T = 'success'|'error'
