import type { colorPalette_T } from './colorPalette_T.js'
export const colorPaletteList = [
	...
	['#e5dac0', '#bcb091', '#9f7b51', '#820d25', '#4a0013'],
	...
	['#c0ffff', '#60ecff', '#fe5380', '#ffbb5e', '#fefefc'],
	...
	['#eee5d6', '#8f0006', '#000000', '#939185', '#98a5ad'],
	...
	['#11665f', '#599476', '#e4d673', '#eb624f', '#ac151c'],
	['#5c4152', '#b4585d', '#d97f76', '#f7d0a9', '#a1c0ae'],
	['#58706d', '#4b5757', '#7c8a6e', '#b0b087', '#e3e3d1'],
	['#f4e1b8', '#9ec7b7', '#acaa9b', '#a5826e', '#7e514b'],
	['#ede5ce', '#fdf6e6', '#ffe2ba', '#f4b58a', '#f7a168'],
	['#ff2121', '#fd9a42', '#c2fc63', '#bcf7ef', '#d7eefa'],
	['#806835', '#f7f1cd', '#6b9e8b', '#a62121', '#130d0d'],
	['#d9d766', '#c5c376', '#a48b86', '#84567a', '#643263'],
	['#6c3948', '#ba5f6e', '#cc8c82', '#ded787', '#f9eabf'],
	['#855f30', '#9ec89a', '#eaba68', '#ff5248', '#f6ffb3'],
	['#d3f7e9', '#fcf3d2', '#fbcf86', '#fa7f46', '#dd4538'],
	['#c3e6d4', '#f4f0e5', '#e0c4ae', '#e1918e', '#e15e6e'],
	['#d92d7a', '#cd4472', '#c25c6a', '#b77463', '#ac8c5e'],
] as colorPalette_T[]
