...
export async function preload(this:PreloadContext, page:page_T, session:ui_ctx__session_T) {
	...
	const { BackOffice_App_Android_Store_Link, BackOffice_App_IOS_Store_Link } = gps.Data
	return { BackOffice_App_Android_Store_Link, BackOffice_App_IOS_Store_Link }
}
</script>

<script lang="ts">
import { Download } from '@menus/download-ui'
export let BackOffice_App_Android_Store_Link:string, BackOffice_App_IOS_Store_Link:string
</script>

<Download
	App_IOS_Store_Link={BackOffice_App_IOS_Store_Link}
	App_Android_Store_Link={BackOffice_App_Android_Store_Link}
></Download>
